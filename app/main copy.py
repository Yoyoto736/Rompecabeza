...
if dir_actual not in sys.path: sys.path.insert(1, dir_actual)
...
# --- PALETA DE 10 TONOS DIFERENCIADOS ---
PALETA_MADERA = {
    -1: "#1e1e1e",
    1: "#E9C46A", 2: "#F4A261", 3: "#E76F51", 4: "#D4A373", 5: "#C68642",
    6: "#A0522D", 7: "#8B4513", 8: "#D2691E", 9: "#BC8F8F", 10: "#A52A2A"
}

MAPA_COLOR_FONDO = {
    "Rojo": "#8b0000", "Azul": "#0b3b60", "Amarillo": "#b8860b",
    "Verde": "#006400", "Morado": "#4b0082", "Naranja": "#cc5500"
}
color_ventana = MAPA_COLOR_FONDO.get(color_seleccionado, "#333333")

if 'motor_puzzle' not in st.session_state: st.session_state.motor_puzzle = RompecabezasMascara()
